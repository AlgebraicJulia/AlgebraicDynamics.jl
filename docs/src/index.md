...
AlgebraicDynamics is a library for compositional dynamical systems. We build on [Catlab.jl](https://algebraicjulia.github.io/Catlab.jl/dev/) to provide a software interface for the specification and solution of dynamical systems with compositional and hierarchical structure. The implementation of the specification and composition of  dynamical systems follows the mathematics of operads and operad algebras. 
